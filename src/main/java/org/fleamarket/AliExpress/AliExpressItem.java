...
public class AliExpressItem implements IItem, Serializable {
    ...
    public AliExpressItem(String url, int price, int sale, int priceWithoutSale, String name, InputStream image, String catalogName, int stars, int numReviews) throws IOException {
        this.url = url;
        this.price = price;
        this.sale = sale;
